    ...
    <div class="app-wrapper">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <a href="dashboard.php" class="nav-item"><i class="fas fa-tachometer-alt"></i> <span>Дашборд</span></a>
                <a href="tables.php?table=orders" class="nav-item <?= $table === 'orders' ? 'active' : '' ?>"><i class="fas fa-clipboard-list"></i> <span>Заказы</span></a>
                <a href="tables.php?table=clients" class="nav-item <?= $table === 'clients' ? 'active' : '' ?>"><i class="fas fa-users"></i> <span>Клиенты</span></a>
                <a href="tables.php?table=services" class="nav-item <?= $table === 'services' ? 'active' : '' ?>"><i class="fas fa-tools"></i> <span>Услуги</span></a>
                <a href="tables.php?table=parts" class="nav-item <?= $table === 'parts' ? 'active' : '' ?>"><i class="fas fa-boxes"></i> <span>Склад</span></a>
                <a href="tables.php?table=payments" class="nav-item <?= $table === 'payments' ? 'active' : '' ?>"><i class="fas fa-money-bill-wave"></i> <span>Расчеты</span></a>
                <?php if ($role === 'Администратор'): ?>
                    <a href="tables.php?table=users" class="nav-item <?= $table === 'users' ? 'active' : '' ?>"><i class="fas fa-user-shield"></i> <span>Пользователи</span></a>
                <?php endif; ?>
                <a href="javascript:void(0)" onclick="showLogoutModal()" class="nav-item"><i class="fas fa-sign-out-alt"></i> <span>Выход</span></a>
            </nav>
        </aside>
